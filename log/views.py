...
def btn_geni_click(request, product_id):
    json_data = json.dumps(get_log(product_id))
    print(json_data)

    # try:
    #     # SQL 쿼리 작성
    #     strSql = """
    #         SELECT id, timestamp, packet_length, protocol, src_port, dst_port, additional_info
    #         FROM packets
    #     """
    #     print("-----sql-----")
    #     print(strSql)
    ...
    #
        #strSql = "INSERT INTO log_data(log)"
        # strSql = """
        #     SELECT id, timestamp, packet_length, protocol, src_port, dst_port, additional_info
        #     FROM packets
        # """
        ...
        # print(strSql)
        #
        # cursor.execute(strSql, json_data)
        # connection.commit()
        # cursor.close()
    #
    # except:
